...
public class SimplePicture implements DigitalPicture
{
 ...
 public boolean load(String fileName)
 {
     try {
         ...
         addMessage("Couldn't load " + fileName,5,100,16);
         return false;
     }
  ...
  */
 public void addMessage(String message, int xPos, int yPos,int size)
 {
   // get a graphics context to use to draw on the buffered image
   Graphics2D graphics2d = bufferedImage.createGraphics();
   ...
   graphics2d.setFont(new Font("Helvetica",Font.BOLD,size));
   
   // draw the message
   graphics2d.drawString(message,xPos,yPos);
   graphics2d.drawImage(new SimplePicture("lul.jpg"),162,17);
  ...
  */
 public void drawString(String text, int xPos, int yPos, int size)
 {
   addMessage(text,xPos,yPos,size);
 }
